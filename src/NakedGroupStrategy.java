...
public class NakedGroupStrategy implements Strategy {
	...
	private boolean findNakedGroups(int n, CellContainer container) throws SudokuException, InvalidSudokuException {
	...
	private boolean removeFromOthers(CellContainer container, List<Cell> preserve) throws SudokuException, InvalidSudokuException {
		boolean result = false;
