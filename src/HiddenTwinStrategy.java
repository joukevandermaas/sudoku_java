...
public class HiddenTwinStrategy implements Strategy{
	...
	private boolean findHiddenTwins(CellContainer container) throws SudokuException {
		// Find two numbers that can go in exactly two cells. If these
		// two cells are the same, all other possibilities should be removed.
	...
	private void removeOtherPossibilities(List<Cell> possibleCells, int n1, int n2) throws SudokuException {
	...
	private Hashtable<Integer, List<Cell>> getPossibilityMap(CellContainer container) {
